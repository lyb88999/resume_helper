...
const (
	...
	// 无效的邮箱格式
	ErrorReason_INVALID_EMAIL ErrorReason = 3
	// 无效的token
...
const file_api_user_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"\x1eapi/user/v1/error_reason.proto\x12\vapi.user.v1\x1a\x13errors/errors.proto*\x92\x01\n" +
	...
	"\rINVALID_TOKEN\x10\x04\x1a\x04\xa8E\x91\x03\x1a\x04\xa0E\xf4\x03B2Z0github.com/lyb88999/resume_helper/api/user/v1;v1b\x06proto3"
