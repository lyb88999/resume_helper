...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	...
	r.GET("/v1/user/{id}", _UserService_GetUserInfo0_HTTP_Handler(srv))
	r.PUT("/v1/user/{id}", _UserService_UpdateUserInfo0_HTTP_Handler(srv))
}
...
func (c *UserServiceHTTPClientImpl) UpdateUserInfo(ctx context.Context, in *UpdateUserInfoRequest, opts ...http.CallOption) (*emptypb.Empty, error) {
